...
public class DemoConsumerRebalance {
    ...
    public static void main(String[] args) {
        args = new String[] { "hadoop2:9092,hadoop3:9092", "topic2", "group2", "consumer2" };
        ...
        consumer.subscribe(Arrays.asList(topic), new ConsumerRebalanceListener(){
            ...
            @Override
            //发生了consumer rebalance，当此partition不再被这个consumer消费了，会调用这个方法。revoke为撤销,废除,取消
